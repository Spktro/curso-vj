...
| 8 | [El jefe aprende a pensar](trabajos-practicos/trabajo-practico-8.md) ([PDF](trabajos-practicos/trabajo-practico-8.pdf)) | **Proyecto final.** Máquina de estados para el **jefe** del TP7 con `enum` + `match`: acechar, perseguir, atacar y **huir**; la horda queda simple. Termina exportando el juego a `.exe` |
